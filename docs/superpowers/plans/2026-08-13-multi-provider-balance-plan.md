...
> 历史计划（已被 2026-08-14 的 Kimi Coding Plan 修正计划取代）：本文当时误把“Kimi
> 额度”理解为 Moonshot API 开放平台余额。v0.6.0 已撤回，当前实现与验收口径请见
> [修正计划](2026-08-14-kimi-coding-plan-correction.md)。
